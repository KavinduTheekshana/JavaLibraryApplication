...
public class ReturnList extends javax.swing.JFrame {
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
       try {
            ResultSet rs;
            if(cmbSchField.getSelectedItem().toString()=="ID"){
                rs = new DbSearch().searchReturnID(txtSearch.getText());
            }
            else if(cmbSchField.getSelectedItem().toString()=="Member Name"){
                rs = new DbSearch().searchReturnMemberName(txtSearch.getText());
            }
            else if(cmbSchField.getSelectedItem().toString()=="Book Name"){
                rs = new DbSearch().searchReturnBookName(txtSearch.getText());
            }
            else{
                rs = new DbSearch().searchReturnID(txtSearch.getText());
            }
    ...
    public void displayBorrowDetails(){
        ResultSet rs = new DbSearch().searchReturn();
        DefaultTableModel dtm = (DefaultTableModel)
                tblBorrow.getModel();
                dtm.setRowCount(0);
        try
